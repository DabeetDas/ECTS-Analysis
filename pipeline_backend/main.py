...
from pipeline_backend.metric_insight import router as metric_insight_router
...
app = FastAPI(title="ECTS Analysis API")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_methods=["*"],
...
app.include_router(metric_insight_router)
